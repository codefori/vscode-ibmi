...
exports.IBMiComponentRuntime = void 0;
const IBMi_1 = __importDefault(require("../IBMi"));
class IBMiComponentRuntime {
    connection;
    component;
    static InstallDirectory = `$HOME/.vscode/`;
    state = `NotChecked`;
    cachedInstallDirectory;
    constructor(connection, component) {
    ...
    setState(newState) {
        this.state = newState;
        return IBMi_1.default.GlobalStorage.storeComponentState(this.connection.currentConnectionName, { id: this.component.getIdentification(), state: newState });
    }
    async overrideState(newState) {
        const installDir = await this.getInstallDirectory();
        await this.component.setInstallDirectory?.(installDir);
        await this.setState(newState);
    }
    async update(installDirectory) {
...
exports.IBMiComponentRuntime = IBMiComponentRuntime;
