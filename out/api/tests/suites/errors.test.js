...
(0, vitest_1.describe)('Filter Tests', { concurrent: true }, () => {
    (0, vitest_1.it)('Basic test (CRTSQLRPGI, member)', () => {
        const lines = [
        ...
        const errors = (0, parser_1.parseErrors)(lines);
        const filePath = `LIAMA/QRPGLESRC/EMPLOYEES`;
        (0, vitest_1.expect)(errors.size).toBe(1);
        (0, vitest_1.expect)(errors.has(filePath)).toBe(true);
        const fileErrors = errors.get(filePath);
        (0, vitest_1.expect)(fileErrors).toBeDefined();
        (0, vitest_1.expect)(fileErrors?.length).toBe(10);
        const errorA = fileErrors.find(err => err.lineNum === 44);
        (0, vitest_1.expect)(errorA).toBeDefined();
        (0, vitest_1.expect)(errorA?.code).toBe(`SQL1001`);
        (0, vitest_1.expect)(errorA?.lineNum).toBe(44);
        (0, vitest_1.expect)(errorA?.toLineNum).toBe(44);
        (0, vitest_1.expect)(errorA?.column).toBe(0);
        (0, vitest_1.expect)(errorA?.toColumn).toBe(0);
        (0, vitest_1.expect)(errorA?.sev).toBe(30);
        (0, vitest_1.expect)(errorA?.text).toBe(`External file definition for EMPLOYEE not found.`);
        const lineErrors = fileErrors.filter(err => err.lineNum === 104);
        (0, vitest_1.expect)(lineErrors.length).toBe(2);
        (0, vitest_1.expect)(lineErrors[0]?.code).toBe(`SQL0312`);
        (0, vitest_1.expect)(lineErrors[0]?.lineNum).toBe(104);
        (0, vitest_1.expect)(lineErrors[0]?.toLineNum).toBe(104);
        (0, vitest_1.expect)(lineErrors[0]?.column).toBe(16);
        (0, vitest_1.expect)(lineErrors[0]?.toColumn).toBe(16);
        (0, vitest_1.expect)(lineErrors[0]?.sev).toBe(30);
        (0, vitest_1.expect)(lineErrors[0]?.text).toBe(`Position 16 Variable EMPLOYEE not defined or not usable. Reason: No declaration for the variable exists, the declaration is not within the current scope, or the variable does not have an equivalent SQL data type.`);
        (0, vitest_1.expect)(lineErrors[1]?.code).toBe(`SQL0312`);
        (0, vitest_1.expect)(lineErrors[1]?.lineNum).toBe(104);
        (0, vitest_1.expect)(lineErrors[1]?.toLineNum).toBe(104);
        (0, vitest_1.expect)(lineErrors[1]?.column).toBe(25);
        (0, vitest_1.expect)(lineErrors[1]?.toColumn).toBe(25);
        (0, vitest_1.expect)(lineErrors[1]?.sev).toBe(30);
        (0, vitest_1.expect)(lineErrors[1]?.text).toBe(`Position 25 Variable FIRSTNME not defined or not usable. Reason: No declaration for the variable exists, the declaration is not within the current scope, or the variable does not have an equivalent SQL data type.`);
    });
    (0, vitest_1.it)('Basic test (CRTSQLRPGI, streamfile)', () => {
        const lines = [
        ...
        (0, vitest_1.expect)(errorA).toBeDefined();
        (0, vitest_1.expect)(errorA?.code).toBe(`SQL1001`);
        (0, vitest_1.expect)(errorA?.lineNum).toBe(41);
        (0, vitest_1.expect)(errorA?.toLineNum).toBe(41);
        (0, vitest_1.expect)(errorA?.column).toBe(0);
        (0, vitest_1.expect)(errorA?.toColumn).toBe(0);
        (0, vitest_1.expect)(errorA?.sev).toBe(30);
        (0, vitest_1.expect)(errorA?.text).toBe(`External file definition for EMPLOYEE not found.`);
        ...
        (0, vitest_1.expect)(lineErrors.length).toBe(2);
        (0, vitest_1.expect)(lineErrors[0]?.code).toBe(`SQL0312`);
        (0, vitest_1.expect)(lineErrors[0]?.lineNum).toBe(106);
        (0, vitest_1.expect)(lineErrors[0]?.toLineNum).toBe(106);
        (0, vitest_1.expect)(lineErrors[0]?.column).toBe(25);
        (0, vitest_1.expect)(lineErrors[0]?.toColumn).toBe(25);
        (0, vitest_1.expect)(lineErrors[0]?.sev).toBe(30);
        (0, vitest_1.expect)(lineErrors[0]?.text).toBe(`Position 25 Variable EMPLOYEE not defined or not usable. Reason: No declaration for the variable exists, the declaration is not within the current scope, or the variable does not have an equivalent SQL data type.`);
        (0, vitest_1.expect)(lineErrors[1]?.code).toBe(`SQL0312`);
        (0, vitest_1.expect)(lineErrors[1]?.lineNum).toBe(106);
        (0, vitest_1.expect)(lineErrors[1]?.toLineNum).toBe(106);
        (0, vitest_1.expect)(lineErrors[1]?.column).toBe(34);
        (0, vitest_1.expect)(lineErrors[1]?.toColumn).toBe(34);
        (0, vitest_1.expect)(lineErrors[1]?.sev).toBe(30);
        (0, vitest_1.expect)(lineErrors[1]?.text).toBe(`Position 34 Variable FIRSTNME not defined or not usable. Reason: No declaration for the variable exists, the declaration is not within the current scope, or the variable does not have an equivalent SQL data type.`);
    });
    (0, vitest_1.it)('Long source file containing spaces (CRTSQLRPGI, streamfile)', () => {
        const lines = [
    ...
    (0, vitest_1.it)('nested copybook (CRTBNDRPG, streamfile)', () => {
        const lines = [
        ...
        (0, vitest_1.expect)(errors.size).toBe(3);
        // should be 3 different file paths
        (0, vitest_1.expect)(errors.has(filePath)).toBe(true);
        (0, vitest_1.expect)(errors.has(copybook_file_path)).toBe(true);
        (0, vitest_1.expect)(errors.has(nested_copybook_file_path)).toBe(true);
        // main file errors
        const fileErrors = errors.get(filePath);
        (0, vitest_1.expect)(fileErrors).toBeDefined();
        (0, vitest_1.expect)(fileErrors?.length).toBe(7);
        // copybook file errors
        const copybook_fileErrors = errors.get(copybook_file_path);
        (0, vitest_1.expect)(copybook_fileErrors).toBeDefined();
        (0, vitest_1.expect)(copybook_fileErrors?.length).toBe(2);
        // nested copybook file errors
        const nested_copybook_fileErrors = errors.get(nested_copybook_file_path);
        (0, vitest_1.expect)(nested_copybook_fileErrors).toBeDefined();
        (0, vitest_1.expect)(nested_copybook_fileErrors?.length).toBe(3);
    });
    (0, vitest_1.it)('filter errors (CRTSQLRPGI, streamfile)', () => {
        const lines = [
        ...
        (0, vitest_1.expect)(errors.size).toBe(2);
        (0, vitest_1.expect)(errors.has(filePath)).toBe(true);
        (0, vitest_1.expect)(errors.has(copybook_file_path)).toBe(true);
        // main file errors
        const fileErrors = errors.get(filePath);
        (0, vitest_1.expect)(fileErrors).toBeDefined();
        (0, vitest_1.expect)(fileErrors?.length).toBe(25);
        // copybook file errors
        const copybook_fileErrors = errors.get(copybook_file_path);
        (0, vitest_1.expect)(copybook_fileErrors).toBeDefined();
        (0, vitest_1.expect)(copybook_fileErrors?.length).toBe(24);
    });
});
