...
export const fr: Locale = {
  ...
  'ifsBrowser.file.tooltip.size': `Taille:\t\t\t{0}`,
  'ifsBrowser.file.tooltip.modified': `Modifié:\t\t{0}`,
  'ifsBrowser.file.tooltip.owner': `Propriétaire:\t{0}`,
  // LibraryListView:
  ...
  'objectBrowser.sourceFile.tooltip.text':'Texte:\t\t{0}',
  'objectBrowser.sourceFile.tooltip.members': 'Membres:\t{0}',
  'objectBrowser.sourceFile.tooltip.length': 'Longueur:\t{0}',
  'objectBrowser.sourceFile.tooltip.CCSID': 'CCSID:\t\t{0}',
  'objectBrowser.member.tooltip.text':'Texte:\t\t\t{0}',
  'objectBrowser.member.tooltip.lines': 'Lignes:\t\t\t{0}',
  'objectBrowser.member.tooltip.created': 'Modification:\t{0}',
  'objectBrowser.member.tooltip.changed': 'Création:\t\t{0}',
  // ProfilesView:
