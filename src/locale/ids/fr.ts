...
export const fr: Locale = {
  ...
  'ifsBrowser.file.tooltip.size':'<tr><td>Taille:</td><td>&nbsp;{0}</td></tr>',
  'ifsBrowser.file.tooltip.modified': '<tr><td>Modifié:</td><td>&nbsp;{0}</td></tr>',
  'ifsBrowser.file.tooltip.owner': '<tr><td>Propriétaire:</td><td>&nbsp;{0}</td></tr>',
  ...
  'objectBrowser.sourceFile.tooltip.text':'<tr><td>Texte:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.sourceFile.tooltip.members': '<tr><td>Membres:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.sourceFile.tooltip.length': '<tr><td>Longueur:</td><td>&nbsp;{0}</td></tr>',
  ...
  'objectBrowser.member.tooltip.text':'<tr><td>Texte:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.member.tooltip.lines': '<tr><td>Lignes:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.member.tooltip.created': '<tr><td>Création:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.member.tooltip.changed': '<tr><td>Modification:</td><td>&nbsp;{0}</td></tr>',
