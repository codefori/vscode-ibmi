...
export const en: Locale = {
  ...
  'ifsBrowser.file.tooltip.size':'<tr><td>Size:</td><td>&nbsp;{0}</td></tr>',
  'ifsBrowser.file.tooltip.modified': '<tr><td>Modified:</td><td>&nbsp;{0}</td></tr>',
  'ifsBrowser.file.tooltip.owner': '<tr><td>Owner:</td><td>&nbsp;{0}</td></tr>',
  ...
  'objectBrowser.sourceFile.tooltip.text':'<tr><td>Text:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.sourceFile.tooltip.members': '<tr><td>Members:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.sourceFile.tooltip.length': '<tr><td>Length:</td><td>&nbsp;{0}</td></tr>',
  ...
  'objectBrowser.member.tooltip.text':'<tr><td>Text:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.member.tooltip.lines': '<tr><td>Lines:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.member.tooltip.created': '<tr><td>Created:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.member.tooltip.changed': '<tr><td>Changed:</td><td>&nbsp;{0}</td></tr>',
