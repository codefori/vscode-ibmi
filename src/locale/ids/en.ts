...
export const en: Locale = {
  ...
  'ifsBrowser.file.tooltip.size': `Size:\t\t{0}`,
  'ifsBrowser.file.tooltip.modified': `Modified:\t{0}`,
  'ifsBrowser.file.tooltip.owner': `Owner:\t\t{0}`,
  // LibraryListView:
  ...
  'objectBrowser.sourceFile.tooltip.text':'Text:\t\t{0}',
  'objectBrowser.sourceFile.tooltip.members': 'Members:\t{0}',
  'objectBrowser.sourceFile.tooltip.length': 'Length:\t\t{0}',
  'objectBrowser.sourceFile.tooltip.CCSID': 'CCSID:\t\t{0}',
  'objectBrowser.member.tooltip.text':'Text:\t\t{0}',
  'objectBrowser.member.tooltip.lines': 'Lines:\t\t{0}',
  'objectBrowser.member.tooltip.created': 'Created:\t{0}',
  'objectBrowser.member.tooltip.changed': 'Changed:\t{0}',
  // ProfilesView:
