...
export const da: Locale = {
  ...
  'ifsBrowser.file.tooltip.begin':'<html><table>',
  'ifsBrowser.file.tooltip.path':'<thead>{0}</thead>',
  'ifsBrowser.file.tooltip.size':'<tr><td>Størrelse:</td><td>&nbsp;{0}</td></tr>',
  'ifsBrowser.file.tooltip.modified': '<tr><td>Ændret:</td><td>&nbsp;{0}</td></tr>',
  'ifsBrowser.file.tooltip.owner': '<tr><td>Ejer:</td><td>&nbsp;{0}</td></tr>',
  'ifsBrowser.file.tooltip.end':'</table></html>',
  // LibraryListView:
  ...
  'objectBrowser.sourceFile.tooltip.begin':'<html><table>',
  'objectBrowser.sourceFile.tooltip.path':'<thead>{0}</thead>',
  'objectBrowser.sourceFile.tooltip.text':'<tr><td>Tekst:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.sourceFile.tooltip.members': '<tr><td>Members:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.sourceFile.tooltip.length': '<tr><td>Længde:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.sourceFile.tooltip.CCSID': '<tr><td>CCSID:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.sourceFile.tooltip.end':'</table></html>',
  'objectBrowser.member.tooltip.begin':'<html><table>',
  'objectBrowser.member.tooltip.path':'<thead>{0}</thead>',
  'objectBrowser.member.tooltip.text':'<tr><td>Tekst:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.member.tooltip.lines': '<tr><td>Linier:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.member.tooltip.created': '<tr><td>Oprettet:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.member.tooltip.changed': '<tr><td>Ændret:</td><td>&nbsp;{0}</td></tr>',
  'objectBrowser.member.tooltip.end':'</table></html>',
  // ProfilesView:
