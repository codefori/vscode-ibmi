...
export const da: Locale = {
  ...
  'ifsBrowser.file.tooltip.size': `Størrelse:\t{0}`,
  'ifsBrowser.file.tooltip.modified': `Ændret:\t{0}`,
  'ifsBrowser.file.tooltip.owner': `Ejer:\t\t{0}`,
  // LibraryListView:
  ...
  'objectBrowser.sourceFile.tooltip.text':'Tekst:\t\t{0}',
  'objectBrowser.sourceFile.tooltip.members': 'Members:\t{0}',
  'objectBrowser.sourceFile.tooltip.length': 'Længde:\t{0}',
  'objectBrowser.sourceFile.tooltip.CCSID': 'CCSID:\t\t{0}',
  'objectBrowser.member.tooltip.text':'Tekst:\t\t{0}',
  'objectBrowser.member.tooltip.lines': 'Linier:\t\t{0}',
  'objectBrowser.member.tooltip.created': 'Oprettet:\t{0}',
  'objectBrowser.member.tooltip.changed': 'Ændret:\t{0}',
  // ProfilesView:
