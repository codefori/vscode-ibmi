...
function initialize(parameters: Partial<ConnectionConfig>): ConnectionConfig {
  return {
    ...
    useMapepireForSourceMemberSaves: (parameters.useMapepireForSourceMemberSaves === true),
    sourceMemberSaveArchiveEnabled: (parameters.sourceMemberSaveArchiveEnabled !== false),
    sourceMemberSaveArchivePath: (parameters.sourceMemberSaveArchivePath || `~/.code-for-ibmi/source-archive`),
    sourceMemberSaveArchiveMaxFiles: (parameters.sourceMemberSaveArchiveMaxFiles || 25),
    ...
    mapepireUseServer: (parameters.mapepireUseServer || false),
    mapepireServerPort: (parameters.mapepireServerPort || 8076),
    mapepireAllowSelfCert: (parameters.mapepireAllowSelfCert || false),
