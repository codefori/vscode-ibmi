...
export default class IBMiSettings {
    ...
    async checkObjectExists(library: string, object: string, type: string): Promise<boolean> {
    ...
    async deleteObject(library: string, object: string, type: string): Promise<boolean> {
