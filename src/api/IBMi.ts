              ...
              if (!commandShellResult.stderr) {
                ...
                if (usesBash) {
                  ...
                  if ((!quickConnect || !cachedServerSettings?.pathChecked)) {
                    ...
                    else if ((currentPaths.indexOf("/usr/bin") !== -1 && (currentPaths.indexOf("/QOpenSys/pkgs/bin") > currentPaths.indexOf("/usr/bin")))
                   || (currentPaths.indexOf("/QOpenSys/usr/bin") !== -1 && (currentPaths.indexOf("/QOpenSys/pkgs/bin") > currentPaths.indexOf("/QOpenSys/usr/bin")))) {
