...
export class Login {
  ...
  static async show(context: vscode.ExtensionContext) {
    ...
    const connectionTab = new Section()
      ...
      .addCheckbox(`useSshAgent`, l10n.t(`Use SSH Agent`), l10n.t(`Enable this to use SSH agent for authentication. The SSH_AUTH_SOCK environment variable must be set.`))
      .addHorizontalRule()
