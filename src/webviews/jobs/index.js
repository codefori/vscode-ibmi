...
class EndjobUI {
    ...
    static async init(jobname, jobuser, jobnumber) {
        ...
        if (jobname && jobuser && jobnumber) {
            ...
            <a href="https://www.ibm.com/docs/en/i/7.4?topic=ssw_ibm_i_74/cl/endjob.htm">IBM i</a>`);
            ui.addField(field);
...
class ChgjobUI {
    ...
    static async init(jobname, jobuser, jobnumber) {
        ...
        if (jobname && jobuser && jobnumber) {
            ...
            <a href="https://www.ibm.com/docs/en/i/7.4?topic=ssw_ibm_i_74/cl/chgjob.htm">IBM i</a>`);
            ui.addField(field);
...
class HldjobUI {
    ...
    static async init(jobname, jobuser, jobnumber) {
        ...
        if (jobname && jobuser && jobnumber) {
            ...
            <a href="https://www.ibm.com/docs/en/i/7.4?topic=ssw_ibm_i_74/cl/hldjob.htm">IBM i</a>`);
            ui.addField(field);
...
class RlsjobUI {
    ...
    static async init(jobname, jobuser, jobnumber) {
        ...
        if (jobname && jobuser && jobnumber) {
            ...
            <a href="https://www.ibm.com/docs/en/i/7.4?topic=ssw_ibm_i_74/cl/rlsjob.htm">IBM i</a>`);
            ui.addField(field);
