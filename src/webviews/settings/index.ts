    ...
    context.subscriptions.push(
      vscode.commands.registerCommand(`code-for-ibmi.showAdditionalSettings`, async (server?: Server, tab?: string) => {
        ...
        mapepireTab
          ...
          .addCheckbox(`mapepireExtendedMetadata`, `Extended description`, `When enabled, requests extended metadata/descriptions for SQL result sets.`, config.mapepireExtendedMetadata)
