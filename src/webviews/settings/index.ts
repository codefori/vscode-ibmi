    ...
    context.subscriptions.push(
      vscode.commands.registerCommand(`code-for-ibmi.showAdditionalSettings`, async (server?: Server, tab?: string) => {
        ...
        featuresTab
          ...
          .addInput(`autoUpdateDirectoryPermissions`, `Automatically update folder security`, `Automatically update home directory and .vscode directory permissions for better security. 'ask' will prompt each time, 'always' will update without prompting, 'never' will skip the check.`, config.autoUpdateDirectoryPermissions)
