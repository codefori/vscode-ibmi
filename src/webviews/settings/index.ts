    ...
    context.subscriptions.push(
      vscode.commands.registerCommand(`code-for-ibmi.showAdditionalSettings`, async (server?: Server, tab?: string) => {
        ...
        featuresTab
          ...
          .addSelect(`mapepireJavaVersion`, `Mapepire Java Runtime`, ["8", "11", "17", "21"].map(value => ({ text: `Java ${value}`, value, description: `Java ${value}`, selected: value === config.mapepireJavaVersion })), "The Java version used to run Mapepire; it must be installed and available on the LPAR.")
            ...
            if (page.data) {
              ...
              switch (button) {
                ...
                default:
                  ...
                  if (connection) {
                    if (!connection.remoteFeatures[`jdk${config.mapepireJavaVersion.padEnd(2, "0")}`]) {
