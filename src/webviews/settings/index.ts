    ...
    context.subscriptions.push(
      vscode.commands.registerCommand(`code-for-ibmi.showAdditionalSettings`, async (server?: Server, tab?: string) => {
        ...
        featuresTab
          ...
          .addSelect(`sqlJobNaming`, `SQL Job Naming`, ["sql", "system"].map((value, index) => ({ text: index ? `System` : 'SQL', value, description: index ? `System` : 'SQL', selected: value === config.sqlJobNaming })), "The naming convention used for running SQL queries and commands on the IBM i.")
