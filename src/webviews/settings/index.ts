        ...
        if (server) {
          ...
          if (connection) {
            ...
            const ui = new CustomUI()
              ...
              .addPassword(`password`, `${vscode.l10n.t(`Password`)}${storedPassword ? ` (${vscode.l10n.t(`Password`)})` : ``}`, vscode.l10n.t(`Password`))
              .addFile(`privateKeyPath`, `${vscode.l10n.t(`Private Key`)}${stored.privateKeyPath ? ` (${vscode.l10n.t(`Private Key`)}: ${stored.privateKeyPath})` : ``}`, vscode.l10n.t(`Private Key`) + ' ' + vscode.l10n.t(`Private Key`))
              .addButtons(
